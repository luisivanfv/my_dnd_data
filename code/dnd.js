...
async function createCharacterSheet(characterData) {
    ...
    popup.show([`green=${character.currentSortingStyle}`]);
    const currentSortingStyle = character.currentSortingStyle || 'default';
                ...
                <div class="tab-content ${activeTab == 'inventory' ? 'active' : ''}" id="inventory-tab" style="background: ${character.secondaryColor};">
                    <div class="inventory-section">
                        ...
                        <div class="currency-section" style="background: ${character.color};">
                            <h3 style="text-align: center; color: ${character.secondaryTextColor}">
                                ${character.gold}
                                <img width="20" height="20" src="https://img.icons8.com/glyph-neue/64/${character.textColor.replace('#', '')}/cheap-2.png" alt="cheap-2"/>
                            </h3>
                        </div>
